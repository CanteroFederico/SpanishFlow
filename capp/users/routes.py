from flask import make_response, render_template, Blueprint, redirect, flash, url_for, request
...
def logout():
    ...
    response = make_response(redirect(url_for('home.home_home')))
    response.headers['Cache-Control'] = 'no-store'
    return response

@users.route('/test-login-status')
